...
define('BLOG_TITLE', 'Dead Simple Blog');

// URL of the homepage. Can be absolute or relative.
define('BASE_URL', '/blog/');

// Contact email is shown as a link in the footer.
define('CONTACT_EMAIL', 'user@example.com');

// The type of files used for your content. Usually 'md' or 'txt'
define('FILE_EXT', 'md');

// light or dark mode
define('APPEARANCE', 'light');

define('CONTACT_LINKDEN', 'https://example.com');

define('CONTACT_GITHUB', 'https://example.com');